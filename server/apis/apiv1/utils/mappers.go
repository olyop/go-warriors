...
func MapGamesResponse(response []nba.Game) []schema.GoWarriorsAPIGame {
...
// MapTeamsResponse maps the NBA API teams response to a GoWarriors API teams response
func MapTeamsResponse(response []nba.Team) schema.GoWarriorsAPIResponse[[]schema.GoWarriorsAPITeam] {
	teams := mapTeams(response)

	return schema.GoWarriorsAPIResponse[[]schema.GoWarriorsAPITeam]{Data: teams}
}
